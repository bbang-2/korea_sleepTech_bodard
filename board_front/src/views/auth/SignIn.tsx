...
import {
  containerStyle, titleStyle, inputStyle, buttonStyle, errorMessageStyle
} from '@/views/auth/auth.style'; // 구조분해할당
import { SignInRequestDto } from '@/dtos/request/auth/sign-in.request.dto';
import { singInRequest } from '@/apis';
...
function SignIn() {
  ...
  const onSignInClick = async () => {
    ...
    const response = await singInRequest(requestBody);
